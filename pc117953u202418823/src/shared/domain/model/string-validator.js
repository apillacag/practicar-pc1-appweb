 ...
 *
 * @summary Provides static helpers to enforce string constraints across the domain.
...
export class StringValidator {
    ...
    /**
     * Checks whether a value is a string that contains at least one non-whitespace character.
     *
     * @param {*} value - The value to evaluate.
